                ...
                <div className='skills-col'>
                    <div className='skills-box'>
                        <div className='skills-content skills-content-one'>
                            ...
                            <div className='progres'>
                                <h2>Tailwind CSS <span>90%</span></h2>
                                <div className='bar'><span></span></div>
                            </div>
                            <div className='progres'>
                                <h2>Bootstrap CSS <span>65%</span></h2>
                                <div className='bar'><span></span></div>
                            </div>
                            <div className='progres'>
                                <h2>JavaScript <span>75%</span></h2>
                                <div className='bar'><span></span></div>
                            </div>
                            <div className='progres'>
                ...
                <div className='skills-col'>
                    <div className='skills-box'>
                        <div className='skills-content skills-content-two'>
                            <div className='progres'>
                                <h2>Firebase<span>75%</span></h2>
                                <div className='bar'><span></span></div>
                            </div>
                            <div className='progres'>
                                <h2>MongoDB <span>80%</span></h2>
                                <div className='bar'><span></span></div>
                            </div>
                            <div className='progres'>
